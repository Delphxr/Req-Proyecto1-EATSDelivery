    ...
    return (
        <IonPage>
            ...
            <IonContent fullscreen>
                ...
                <IonCard style={{ height: "20%" }}>
                    <IonTextarea placeholder="Escriba aqui los ingredientes, separados por coma" value={ingredientes} onIonChange={e => setingredientes(e.detail.value!)}></IonTextarea>
                </IonCard>


                <IonCard>
                    <IonInput value={precio} placeholder="Precio" type="number" onIonChange={e => setprecio(e.detail.value!)}></IonInput>
                </IonCard>

                <IonCard style={{ height: "20%" }}>
                    <IonTextarea placeholder="Escriba aqui la descripcion del producto" value={descripcion} onIonChange={e => setdescripcion(e.detail.value!)}></IonTextarea>
                </IonCard>
